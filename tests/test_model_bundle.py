...
class ModelBundleTests(unittest.TestCase):
    def test_current_model_bundle_loads_and_passes_contract(self) -> None:
        ...
        self.assertEqual(len(loaded["cluster_assignments"]), 1277)
    ...
    def test_current_model_metrics_are_regression_guarded(self) -> None:
        ...
        self.assertAlmostEqual(metrics["silhouette"], 0.3466360623521399, places=6)
        self.assertAlmostEqual(metrics["davies_bouldin"], 1.3957850999644126, places=6)
        self.assertAlmostEqual(metrics["calinski_harabasz"], 443.46798797095164, places=4)
