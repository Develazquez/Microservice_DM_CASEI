...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| v2 | 1000 | 38 | 72 | 4 | 6 | 5 | 76.014 | 63.034 | 1.356 |
...
| non_negative_periodos_cursados | True | 0 | alta | periodos_cursados no debe tener valores negativos. |
| non_negative_periodos_sin_inscripcion | True | 0 | alta | periodos_sin_inscripcion no debe tener valores negativos. |
| non_negative_materias_reprobadas_periodo | True | 0 | alta | materias_reprobadas_periodo no debe tener valores negativos. |
| non_negative_materias_reprobadas_acumuladas | True | 0 | alta | materias_reprobadas_acumuladas no debe tener valores negativos. |
| non_negative_materias_en_curso_periodo | True | 0 | alta | materias_en_curso_periodo no debe tener valores negativos. |
| period_credits_consistency | True | 0 | alta | Creditos aprobados del periodo no debe exceder creditos inscritos. |
| progress_matches_credits | True | 0 | alta | porcentaje_avance debe ser compatible con creditos acumulados / creditos del plan. |
| baja_temporal_without_active_load | True | 0 | alta | Baja Temporal no debe tener materias activas en snapshot v2. |
| recursamientos_not_greater_than_failed_accumulated | True | 0 | alta | Recursamientos no debe exceder reprobadas acumuladas. |
| lag_not_below_failed_minus_retake | True | 0 | media | Rezago debe cubrir reprobadas acumuladas no regularizadas. |
| controlled_missing_values | True | 0 | media | Solo se permiten nulos controlados en variables no aplicables por baja. |
